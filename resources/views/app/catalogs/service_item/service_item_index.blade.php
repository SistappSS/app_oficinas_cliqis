...
@section('content')
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h1 class="text-xl font-semibold">Serviços cadastrados</h1>
        </div>

        <!-- busca + ações -->
        <div class="mt-4 flex items-center gap-4">
            <div class="relative w-full max-w-xl">
                <input id="search" placeholder="Buscar por nome, descrição ou tipo de serviço..."
        ...
        <div class="mt-5 mb-8 rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div>
                <table class="min-w-full text-sm">
                    ...
                    <tr>
                        <th class="px-6 py-4 first:rounded-tl-2xl text-left">Serviço</th>
                        <th class="px-3 py-4 text-left">Tipo de serviço</th>
                        <th class="px-3 py-4 text-left">Descrição</th>
                        <th class="px-3 py-4 text-right">Valor unitário (R$)</th>
    ...
    @include('app.catalogs.service_item.service_item_modal')
    @include('layouts.common.modal.modal_delete')
@endsection

@push('scripts')
    <script type="module" src="{{ asset('assets/js/template/views/catalogs/service-item.js') }}"></script>
@endpush
