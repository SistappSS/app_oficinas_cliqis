...
@section('content')
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h1 class="text-xl font-semibold">Peças</h1>
        </div>

        <!-- busca + ações -->
        <div class="mt-4 flex items-center gap-4">
            <div class="relative w-full max-w-xl">
                <input id="search" placeholder="Buscar por código, nome, NCM ou fornecedor..."
        ...
        <div class="mt-5 mb-8 rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div>
                <table class="min-w-full text-sm">
                    ...
                    <tr>
                        <th class="px-6 py-4 first:rounded-tl-2xl text-left">Código</th>
                        <th class="px-3 py-4 text-left">Nome da peça</th>
                        <th class="px-3 py-4 text-left">Fornecedor</th>
                        <th class="px-3 py-4 text-left">NCM</th>
...
@push('scripts')
    <script type="module" src="{{ asset('assets/js/template/views/catalogs/part.js') }}"></script>
@endpush
