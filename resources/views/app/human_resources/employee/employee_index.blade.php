...
@section('content')
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div class="mt-4 flex items-center gap-4">
            <div class="relative w-full max-w-xl">
                <input id="search" placeholder="Buscar por nome, e-mail, documento ou telefone..."
        ...
        <div class="mt-5 mb-8 rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div>
                <table class="min-w-full text-sm">
                    ...
                    <tr>
                        <th class="px-6 py-4 first:rounded-tl-2xl text-left">Nome</th>
                        <th class="px-3 py-4 text-left">Documento</th>
                        <th class="px-3 py-4 text-left">E-mail</th>
                        <th class="px-3 py-4 text-left">Telefone</th>
                        <th class="px-3 py-4 text-left">Cargo</th>
                        <th class="px-3 py-4 text-right">Valor hora (R$)</th>
                        <th class="px-3 py-4 text-center">Técnico?</th>
    ...
    @include('app.human_resources.employee.employee_modal')
    @include('layouts.common.modal.modal_delete')
@endsection

@push('scripts')
    <script type="module" src="{{ asset('assets/js/template/views/human-resources/employee.js') }}"></script>
@endpush
