...
@section('content')
        ...
        <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3" id="stock-kpis">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm p-4 lg:col-span-1">
                ...
                <div class="mt-2 text-sm text-slate-700">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-semibold text-slate-900" id="kpi-in-7">—</span>
                    </div>
                    <div class="flex items-center justify-between mt-1">
                        <span class="text-xs text-slate-500">30d</span>
                        <span class="font-semibold text-slate-900" id="kpi-in-30">—</span>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm p-4 lg:col-span-1">
                ...
                <div class="mt-2 text-sm text-slate-700">
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-slate-500">7d</span>
                        <span class="font-semibold text-slate-900" id="kpi-out-7">—</span>
                    </div>
                    <div class="flex items-center justify-between mt-1">
                        <span class="text-xs text-slate-500">30d</span>
                        <span class="font-semibold text-slate-900" id="kpi-out-30">—</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="stock-move-modal" class="fixed inset-0 z-[90] hidden">
        ...
        <div class="absolute inset-x-0 top-10 mx-auto w-[min(980px,calc(100%-2rem))]">
                ...
                <div class="px-6 py-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <select id="sm-type" class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-200">
                        ...
                        <div>
                            ...
                            <select id="sm-location" class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-200"></select>
                        </div>
            ...
            <div id="sm-toast" class="fixed right-4 top-4 z-[95] hidden rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-lg">
    ...
    {{-- Modal Log Item --}}
    <div id="stklog-modal" class="fixed inset-0 z-[80] hidden">
