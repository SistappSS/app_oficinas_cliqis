    ...
    <main class="mx-auto max-w-7xl px-4 sm:px-6 pb-10 lg:pb-14">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mt-4">
            <div>
                ...
                <p class="text-sm text-slate-500">Personalize entradas/saídas (tenant) e mantenha os motivos do sistema.</p>
            </div>
            ...
            <div class="rounded-2xl bg-white shadow-xl border border-slate-200 overflow-hidden">
                ...
                <div class="px-6 py-5 space-y-4">
                    ...
                    <div class="flex items-center justify-end gap-2 pt-2">
                        <button type="button" class="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 hover:bg-slate-50" data-r-close>
                            Cancelar
                        </button>
                        <button id="r-save" type="button" class="rounded-xl bg-blue-600 px-4 py-2 text-sm text-white hover:bg-blue-700">
                            Salvar
                        </button>
                    </div>
                </div>
