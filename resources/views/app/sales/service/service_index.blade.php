...
@section('content')
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 pb-10 lg:pb-14 flex flex-col gap-4">
        <!-- topo -->
        ...
        <div class="flex items-center gap-4">
            <div class="relative w-full max-w-xl">
                <input id="search" placeholder="Buscar por nome, preço, recorrência..."
            ...
            <div class="">
                <table class="min-w-full text-sm">
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-4 text-center">Recorrência</th>
    ...
    @include('app.sales.service.service_modal')
@endsection

@push('scripts')
    <script type="module" src="{{ asset('assets/js/template/views/sales/service.js') }}"></script>
@endpush
