            ...
            <div>
                <table class="min-w-full text-sm">
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-4 text-center">Tipo</th>
                        <th class="px-3 py-4 text-left">Perfis / Roles</th>
                        <th class="px-3 py-4 text-right">Criado em</th>
...
@push('scripts')
    <script type="module" src="{{ asset('assets/js/template/views/entities/user.js') }}"></script>
@endpush
