...
@section('content')
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div class="mt-4 flex items-center gap-4">
            <div class="relative w-full max-w-xl">
                <input id="search" placeholder="Buscar por nome, e-mail, cidade..."
    ...
    @include('app.entities.supplier.supplier_modal')
    @include('layouts.common.modal.modal_delete')
@endsection

@push('scripts')
    <script type="module" src="{{ asset('assets/js/template/views/entities/supplier.js') }}"></script>
@endpush
