@push('styles')
    <style>
        ...
        #supplier-modal .section-title{
            display:flex;align-items:center;gap:.5rem;
            color:#0f172a;font-weight:600
        }
        #supplier-modal .section-title .dot{
        ...
        #supplier-modal input[type="text"],
        #supplier-modal input[type="email"],
        #supplier-modal input[type="tel"],
        #supplier-modal input[type="password"],
        #supplier-modal input[type="date"],
        #supplier-modal input[type="number"],
...
<x-modal modalId="supplier-modal" formId="supplier-form" modalTitle="Novo fornecedor" :input="$input">
    <div class="space-y-6">
        <!-- Título seção -->
        <div class="section-title">
            <span class="dot">
                <svg viewBox="0 0 24 24" class="h-3.5 w-3.5" fill="none">
                    <path d="M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm7 7a7 7 0 0 0-14 0" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>
                </svg>
            </span>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <x-input col="" set="" id="name" name="name" type="text" label="Nome do fornecedor" placeholder="Sistapp Soluções e Sistemas"></x-input>
        ...
        <div class="card">
            <div class="grid gap-4 sm:grid-cols-2 items-center">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-slate-800">Fornecedor ativo?</p>
