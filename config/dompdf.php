...
return [
    ...
    */
    ...
    'options' => [
         ...
         * that determine if a resouce may be loaded. Full supports is not guaranteed
         ...
         * image and font supports, etc.) differ between backends.  Please see
         ...
         * look at {@link GD_Adapter} for more information.  GD supports is
