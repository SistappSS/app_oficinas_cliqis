...
document.addEventListener("DOMContentLoaded", () => {
    new ModelCrud({
        ...
        btnSubmit: "#m-submit",
        routes: {
            index: "/entities/customer-api",
            store: "/entities/customer-api",
            update: "/entities/customer-api",
            delete: "/entities/customer-api",
        },
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="menu-${r.id}" class="hidden absolute right-0 top-full z-50 mt-2 w-48 rounded-2xl overflow-hidden border border-slate-200 bg-white shadow-xl ring-1 ring-black/5"
                                ...
                                <ul class="py-1 text-sm text-slate-700">
                                     <li>
                                        <button type="button" class="block w-full px-3 py-2 text-left bg-transparent rounded-none hover:bg-slate-50 focus:outline-none" data-customer-area data-id="${r.id}">Área do Cliente</button>
                                    </li>
                                    <li>
