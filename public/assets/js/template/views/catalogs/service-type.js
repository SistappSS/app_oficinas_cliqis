...
document.addEventListener("DOMContentLoaded", () => {
    new ModelCrud({
        ...
        btnSubmit: "#m-submit",
        routes: {
            index: "/catalogs/service-type-api",
            store: "/catalogs/service-type-api",
            update: "/catalogs/service-type-api",
            delete: "/catalogs/service-type-api",
        },
...
<tr class="hover:bg-slate-50">
    ...
    <td class="px-6 py-3 text-center whitespace-nowrap">
        ...
        fillForm: (st) => {
            document.querySelector("#service_type_id").value = st.id || "";
            document.querySelector("#name").value = st.name || "";
            document.querySelector("#description").value = st.description || "";
            document.querySelector("#is_active").checked = !!st.is_active;
        },
        ...
        getId: () => document.querySelector("#service_type_id").value,
    });
});
